...
program
	.command('list [date]')
	.description('Resume time of the taks. You can pass the date on format configured (' + ((config && config.all && config.all.config && config.all.config.date_format) ? config.all.config.date_format : 'MM/dd/yyyy') + ').')
	.alias('l')
	.action((date) => {
...
program
	...
	.description('Add a task with a specific time spent and on a specific date. You can pass the date on format configured (' + ((config && config.all && config.all.config && config.all.config.date_format) ? config.all.config.date_format : 'MM/dd/yyyy') + ').')
	.alias('a')
